...
namespace Samples.Server.Data.Context.AdoDotNet
{
    ...
    public class AppDbContext : IDbContext
    {
        ...
        private void Initialize()
        {
            ...
            _dbMapperBuilder.AddMapping<CourtLevel, CourtLevelsTableAdapter, SampleDataSet.CourtLevelsDataTable>(dataRow =>
            {
                var courtLevelsRow = (SampleDataSet.CourtLevelsRow)dataRow;
